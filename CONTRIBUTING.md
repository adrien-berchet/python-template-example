...
* Create a local development environment using `uv`:
...
* Commit the release metadata and changelog:
...
After these steps the GitHub workflows should automatically build the package,
publish it to PyPI, and create a GitHub release.

[github]: https://github.com/adrien-berchet/python-template-example
